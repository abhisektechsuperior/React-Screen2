        ...
        <div className="row m-1 row  justify-content-evenly m-0 d-flex">
            ...
            <div className="row m-2 ">
              <div className="col-md-6 col-sm-8 p-0 mx-0">
                <div className="locationManImage">
                  <img className='img-edit' src="https://wpassets.adda247.com/wp-content/uploads/multisite/sites/5/2023/06/16111548/Kedarnath.jpg" alt="" />
                </div>
                <div className="row m-0">
                  <div className="col-4 p-0">
                    <img src="https://i.pinimg.com/originals/73/96/8e/73968e896bf71fd43e46c5bbdee15f13.jpg" alt="" />
                  </div>
                  <div className="col-4 p-0">
                    <img src="https://i.pinimg.com/originals/73/96/8e/73968e896bf71fd43e46c5bbdee15f13.jpg" alt="" />
                  </div>
              ...
              <div class="col-md-6 col-sm-6 bg-white align-items-stretch ">
                ...
                <div className="holidayIcons row m-0 my-4">
                  <div className="col">
                    <img  src="https://img.freepik.com/premium-photo/isolated-blue-umbrella-white-background_100488-823.jpg?w=2000" alt="" />
                  </div>
                  <div className="col">
                    <p>1</p>
                  </div>
                  <div className="col">
                    <img  src="https://img.freepik.com/premium-photo/blank-notepad-white-background_196767-568.jpg?w=2000" alt="" />
                  </div>
                  <div className="col">
                    <p>2</p>
                  </div>
          ...
          <div className="card-col-md-5 col-sm-8 m-2 align-items-stretch d-flex  ">
            <div className="row m-2">
              <div className="col-md-6 col-sm-8 p-0 mx-0">
                <div className="locationManImage">
                  <img className='img-edit' src="https://i.ytimg.com/vi/7NKk41YVWyA/maxresdefault.jpg" alt="" />
                </div>
                <div className="row m-0">
                  <div className="col-4 p-0">
                    <img src="https://images.prismic.io/indiahike/1359b205-9e4c-4fbf-8dc4-e2b60b2a0baa_Manali+Campus.png?auto=compress,format&rect=0,0,800,550&w=1200&h=825" alt="" />
                  </div>
                  <div className="col-4 p-0">
                    <img src="https://images.prismic.io/indiahike/1359b205-9e4c-4fbf-8dc4-e2b60b2a0baa_Manali+Campus.png?auto=compress,format&rect=0,0,800,550&w=1200&h=825" alt="" />
                  </div>
        ...
        {/* <div className="row m-2 d-lg-flex justify-content-center p-0 align-items-stretch d-flex "> */}
          <div className="card-col-md-5 col-sm-8 m-2 align-items-stretch d-flex  ">
            <div className="row m-2">
              <div className="col-md-6 col-sm-8 p-0 mx-0">
                ...
                <div className="row m-0">
                  <div className="col-4 p-0">
                    <img src="https://assets-news.housing.com/news/wp-content/uploads/2022/08/01072310/Goa-feature-compressed.jpg" alt="" />
                  </div>
                  <div className="col-4 p-0">
                    <img src="https://assets-news.housing.com/news/wp-content/uploads/2022/08/01072310/Goa-feature-compressed.jpg" alt="" />
                  </div>
          ...
          <div className="card-col-md-5 col-sm-8 m-2 align-items-stretch d-flex ">
            <div className="row m-2">
              <div className="col-md-6 col-sm-8 p-0 mx-0">
                <div className="locationManImage">
                  <img className='img-edit' src="https://i.ytimg.com/vi/h4EEmCa1hEI/maxresdefault.jpg" alt="" />
                </div>
                <div className="row m-0">
                  <div className="col-4 p-0">
                    <img src="https://lh3.googleusercontent.com/p/AF1QipMWVWSIxyZ_WDOe6oemlYbg3NBiqZwaLw5umGHX=w1080-h608-p-no-v0" alt="" />
                  </div>
                  <div className="col-4 p-0">
                    <img src="https://lh3.googleusercontent.com/p/AF1QipMWVWSIxyZ_WDOe6oemlYbg3NBiqZwaLw5umGHX=w1080-h608-p-no-v0" alt="" />
                  </div>
